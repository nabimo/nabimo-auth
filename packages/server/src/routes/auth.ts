...
function authErrorStatus(code: string): number {
  switch (code) {
    ...
    case "OTP_COOLDOWN": case "OTP_RATE_LIMITED": return 429;
    case "INVALID_CREDENTIALS": case "INVALID_OTP": case "INVALID_PASSWORD_RESET_TOKEN": case "INVALID_2FA_CODE": case "TWO_FACTOR_REQUIRED": return 401;
    default: return 400;
  }
}
